...
onEvent("recipes", (event) => {
  ...
  if (!useTinkerMoltenOnlyFromSteelUp) {
    event.recipes.create.mixing({
      ingredients: [
        { item: "create_modpack_glue:iron_weapon_ingot" },
        { item: "create_modpack_glue:cleaning_composite" },
      ],
    ...
    event.recipes.create.mixing({
      ...
      results: [
        { item: "create_modpack_glue:diamond_weapon_composite", count: 1 },
      ],
      processingTime: 100,
    ...
    event.recipes.create.pressing({
      ingredients: [
        { item: "create_modpack_glue:diamond_weapon_composite", count: 9 },
      ],
    ...
    event.recipes.create.mixing({
      ...
      results: [
        { item: "create_modpack_glue:adv_cleaning_component", count: 1 },
      ],
      processingTime: 100,
    });
    ...
    event.recipes.create.pressing({
      ingredients: [
        { item: "create_modpack_glue:adv_cleaning_component", count: 9 },
      ],
      results: [
        { item: "create_modpack_glue:adv_cleaning_composite", count: 1 },
      ],
      processingTime: 300,
    });
    ...
    event.recipes.create.mixing({
      ingredients: [
        { item: "create_modpack_glue:adv_cleaning_composite" },
        { item: "minecraft:netherite_scrap" },
      ],
      results: [
        { item: "create_modpack_glue:inpure_netherite_dust", count: 1 },
      ],
      processingTime: 100,
      heatRequirement: "heated",
    });
    ...
    event.blasting(
      ...
      "create_modpack_glue:inpure_netherite_dust"
    );
  }

  {
    ...
    event.replaceInput(
      { mod: "tconstruct", id: /crafting_station/ },
      "tconstruct:pattern",
  ...
  for (let material in crushingRecipes) {
    if (
      !withMekanism ||
      (!material.includes("mekanism") &&
        !crushingRecipes[material].includes("mekanism"))
    ) {
  ...
  event.replaceInput(
    { id: "ring_of_repair:ring_of_repair" },
  ...
  event.replaceInput(
    { mod: "storagedrawers", id: /controller/ },
  ...
  event.replaceInput(
    { mod: "storagedrawers", id: /compacting/ },
    "minecraft:piston",
  ...
  event.replaceInput(
    { id: "storagedrawers:concealment_key" },
    "minecraft:ender_eye",
    "create:copper_nugget"
  );
  /*
...
*/
  ...
  for (const m of [
    ...
    event.recipes.create.crushing({
      ...
      results: [
        { item: `create_modpack_glue:${m.n}_grain` },
        { item: `create_modpack_glue:${m.n}_grain`, chance: 0.2 },
      ],
      processingTime: 100,
    });
	...
	if(!m.washingResults) {
		...
		event.custom({
		  ...
		  "results": n.washingResults.map((it)=>({item: it.n, chance: it.p }))
		});
		
		for(let it of n.washingResults) {
			if(!it.fluid) {
				continue;
			}
			event.custom({
...
onEvent("fluid.tags", (event) => {
  ...
  // );
  event.add(
    "create_modpack_glue:molten_cleaner",
    "create_modpack_glue:molten_cleaner"
  );
  event.add(
    "create_modpack_glue:adv_molten_cleaner",
    "create_modpack_glue:adv_molten_cleaner"
  );
  event.add(
    "create_modpack_glue:weapon_molted_iron",
    "create_modpack_glue:weapon_molted_iron"
  );
  event.add(
    "create_modpack_glue:weapon_molted_steel",
    "create_modpack_glue:weapon_molted_steel"
  );
  event.add(
    "create_modpack_glue:weapon_molted_diamond",
    "create_modpack_glue:weapon_molted_diamond"
  );
});
